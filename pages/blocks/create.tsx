...
const BlockCreationPage: NextPage = () => {
    ...
    return <div>
        ...
        <div className="p-8">
            ...
            <div>
                A study block is a collection of courses, like a trimester or a semester at some universities.
            </div>
            ...
            <Formik
                ...
                onSubmit={(values, { setSubmitting } ) => {
                    fetch(`/api/block/create`, { method: 'POST', headers: { 'Content-Type': 'application/json'}, body: JSON.stringify(values)}).then(e => e.json()).then(f => {
            ...
            >
                {({
                    ...
                    <Form className="mt-4" onSubmit={handleSubmit}>
                        ...
                        <Button type='submit' isLoading={isSubmitting} colorScheme='teal'>Submit</Button>
                    </Form>
                )}
